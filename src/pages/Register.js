    ...
    <div id="register" className="w-screen flex flex-col items-center justify-center min-h-screen bg-shadyblue overflow-x-hidden">
      <div className="w-full max-w-xs sm:max-w-sm ">
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg px-8 pt-6 pb-8 mb-4">
          ...
          <div className="mt-7">
            <label className="flex justify-center items-center font-medium cursor-pointer mx-12 sm:mx-20" htmlFor="avatar">
              <MdAddPhotoAlternate className="w-9 h-9 rounded-t text-shadyblue"/>
                Add your Avatar 
            </label>
            <input onChange={(e)=>setFile(e.target.files[0])} type="file" id="avatar" className="invisible w-0 h-0"  />
          </div>
          <div className="mt-0">
